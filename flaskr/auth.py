...
def login():
    if request.method == 'POST':
        ...
        if error is None:
            session.clear()
            # stores user id in a new session. The data is stored in a cookie
            # that is sent to the browser, and the browser then sends is back
...
def login_required(view):
    """
    Decorator to check if a user is loaded and redirects to the login page
    otherwise.
    """
